<template>
  ...
  <div class="wrapper" id="app" style="background-color:#e0edfb"><!--  提示信息-->
    <center><div> <el-alert v-if="showSuccess" title="登录成功！！" type="success" effect="dark" center show-icon/>
    <el-alert v-if="showWarning" title="登录失败，账号密码不正确！" type="warning" effect="dark" center show-icon />
    <el-alert v-if="showerror" title="输入格式有误！！！" type="error" effect="dark" center show-icon />
    </div></center>
    <div class="card-form">
      <div class="card-list">
        <div class="card-item" v-bind:class="{ '-active': isCardFlipped }">
          <div class="card-item__side -front">
            ...
            <div class="card-item__cover">
              ...
              <center><h1 class="title_hearder">GH博客(登录)</h1></center>
              <!--   //标题 -->
            </div>
          ...
          <div class="card-item__side -back">
            ...
            <div class="card-item__cvv">
              <div class="card-item__cvvTitle">手机号码(进行隐私处理)</div>
      ...
      <div class="card-form__inner">
        ...
        <button class="card-form__button" @click="show">登录</button>
        <h5>还未有账户？<router-link to="/regi">注册</router-link></h5>
      </div>
    </div>
  ...
  methods: {
   ...
   show(){
      ...
      let parms={
       ...
       axios.post("http://localhost:8080/Vue_SSM/users/isexist",parms).then((requeat)=>{
        // 请求成功进行判断
        aa = requeat.data
         if(aa ===  1){
       setTimeout(() => {
...
<style lang="scss" src='../assets/conn.scss' scoped></style>
<style lang="css" src='../assets/wap.css' scoped></style>
<style scoped>
